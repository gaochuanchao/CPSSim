...
TEST_CASE("Bosch analysis maps typed signals, thresholds, intervals, and deadline markers",
    ...
    auto adjacent = analysis;
    adjacent.critical_intervals = {{1, 2}, {3, 4}, {10, 12}};
    REQUIRE(visible_bosch_critical_intervals(adjacent, 2, 5) ==
            std::vector<BoschCriticalInterval>{{2, 4}});
